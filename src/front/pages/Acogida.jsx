...
export const Acogida = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert(data.success ? "✅ Formulario enviado correctamente, revisa tu correo" : "❌ Error al enviar: " + data.error);
        } catch (error) {
            ...
            <div className="container my-5">
                <div className="card shadow-lg border-0 rounded-4">
                    <div className="text-center p-4">
                        <h3 className="mb-3">🐾 ¡Hazte casa de acogida y salva vidas! 🐾</h3>
                        <p className="fs-5">En nuestra protectora recibimos muchos gatos que necesitan un lugar seguro donde recuperarse, socializar y esperar a su familia definitiva.</p>
                        <p>Las casas de acogida son un <strong>pilar fundamental</strong> para nosotros: gracias a ellas, los gatos pueden salir del refugio o de la calle y vivir temporalmente en un hogar lleno de cuidados y cariño.</p>
                        <h5 className="mt-4">👉 ¿Qué significa ser casa de acogida?</h5>
                        ...
                        <p className="mt-4">💜 Lo único que pedimos es <strong>compromiso y responsabilidad</strong>. Nosotros nos encargamos de los gastos veterinarios y ofrecemos asesoramiento y apoyo en todo momento.</p>
                        <p>Ser casa de acogida no solo salva vidas, también te da la oportunidad de vivir una experiencia única: acompañar a un gato en su camino hacia su hogar definitivo.</p>
                ...
                <div className="row justify-content-center w-100">
                    <div className="col-12 col-sm-12 col-md-10 col-lg-8 col-xl-6">
                        <div className="input-box m-2">
                            <h3>Sobre ti</h3>
                            <input className="my-2" name="name" type="text" placeholder="Nombre" onChange={handleChange} required />
                            <input className="my-2" name="age" type="number" placeholder="Edad" onChange={handleChange} required />
                            <input className="my-2" name="phone" type="tel" placeholder="Teléfono" onChange={handleChange} required />
                            <input className="my-2" name="email" type="email" placeholder="Email" onChange={handleChange} required />
                        </div>
                        <div className="input-box m-2">
                            ...
                            <select className="my-2" name="company" onChange={handleChange} required>
                                ...
                                <option value="Vivo con mi pareja o familia y mis hijos gatunos/perrunos">Vivo con mi pareja o familia y mis hijos gatunos/perrunos</option>
                            ...
                            <textarea name="otherAnimals" placeholder="¿Hay otros animales en casa? ¿Qué tipo de animales son? ¿Están vacunados, chipados y desparasitados?" onChange={handleChange} required />
